...
class FinetuningGAT(torch.nn.Module):
    ...
    def FinetunningGAT(self,account_info_list,post_info_list):
        ...
        for data in data_sets:
            ...
            for epoch in range(args.num_epochs):
                retweet_probabilities = self.train_and_test(model,data, train_mask, test_mask, optimizer, loss_fn)
    ...
    def update_retweet_prob(self,account_info_list, post_info_list):
        retweet_pos_probability, retweet_neg_probability = self.FinetunningGAT(account_info_list, post_info_list)
