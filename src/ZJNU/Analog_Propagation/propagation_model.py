...
class ICResult:
    def __init__(self, P_S=None, P_I1=None, P_I2=None, P_R=None, activation_paths_info1=None,
                 activation_paths_info2=None, step_activations_info1=None, step_activations_info2=None):
        """
    ...
    def build_user_network1(account_info_list):
        ...
        for account_info in account_info_list:
            ...
            for follower in account_info.followers:
                # 添加边：粉丝关注用户
                G.add_edge(account_info.account_id, follower.account_id)  # follower <- user

            G.nodes[account_info.account_id]['w'] = account_info.retweet_neg_probability  # 根据账号的 retweet_probability 设置权重
    ...
    def build_user_network2( account_info_list):
        ...
        for account_info in account_info_list:
            ...
            # G.nodes[account_info.account_id]['w'] = account_info.retweet_pos_probability  # 根据账号的 retweet_probability 设置权重
            G.nodes[account_info.account_id]['w'] = account_info.retweet_probability
        return G
    ...
    def IC1(cls,selected_id_nodes,account_info_list,max_iter_num):
        ...
        return cls(P_S=state0_count, P_I1=activated_count, P_R=state2_count, activation_paths_info1=activation_paths, step_activations_info1=activation_steps)
    ...
    def IC2(cls, selected_id_nodes,account_info_list,max_iter_num):
        ...
        return cls(P_S=state0_count, P_I2=activated_count, P_R=state2_count, activation_paths_info2=activation_paths, step_activations_info2=activation_steps)
    ...
    def build_user_network3(account_info_list):
        ...
        for account_info in account_info_list:
            ...
            G.nodes[account_info.account_id]['w1'] = account_info.retweet_neg_probability  # 根据账号的 retweet_probability 设置权重
            G.nodes[account_info.account_id]['w2'] = account_info.retweet_pos_probability  # 根据账号的 retweet_probability 设置权重
    ...
    def IC_vs(cls, selected_id_nodes,account_info_list,max_iter_num):
        ...
        return cls(P_S, P_I1, P_I2, P_R, activation_paths_info1, activation_paths_info2, step_activations_info1,step_activations_info2)
    ...
    def simulation_all(self, selected_id_nodes,account_info_list,flag):
        ...
        if flag == 1:
            ...
            result = ICResult.IC_vs(selected_id_nodes,account_info_list,max_iter_num=20)
        else:
...
if __name__ == "__main__":
    from src.ZJNU.Analog_Propagation.test_data import account_info_list
    ic_result = ICResult()
