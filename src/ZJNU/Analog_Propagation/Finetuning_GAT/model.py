...
class GAT(torch.nn.Module):
    def __init__(self, in_channels, out_channels, heads,hidden_channels=64):
        ...
        self.conv2 = GATConv(hidden_channels * heads, hidden_channels, heads=1,dropout=0.6)  # 第二层GAT
...
class GATModel(nn.Module):
    def __init__(self, user_feature_dim, post_feature_dim, hidden_dim, output_dim, num_heads=4):
