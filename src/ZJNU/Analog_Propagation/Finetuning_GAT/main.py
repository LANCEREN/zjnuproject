...
class FinetuningGAT(torch.nn.Module):
    ...
    def FinetunningGAT(self):
        ...
        parser.add_argument(
            "--node_features_file",
            type=str,
            default="../zjnuproject-master1/Influence_Prediction/out/test.content",
            help="Path to the node features file",
        )
        parser.add_argument(
            "--edges_file",
            type=str,
            default="../zjnuproject-master1/Feature_Extract/out/微博用户关注关系.txt",
        ...
        parser.add_argument(
            "--output_file",
            type=str,
            default="../zjnuproject-master1/Finetuning_GAT/output/predicted_retweet_probabilities_3.txt",
        ...
        influence_vector_file = (
            "../zjnuproject-master1/Influence_Prediction/out/influence.npy"
        )
        ...
        node_features = data_process.concatenate_features_and_influence(
            x, influence_vector
        )
        ...
        for epoch in range(args.num_epochs):
            ...
            if epoch % 10 == 0:
                ...
                with torch.no_grad():
                    ...
                    train_acc, train_prec, train_rec, train_f1 = self.calculate_metrics(
                        data.y[train_mask], train_pred
                    )
